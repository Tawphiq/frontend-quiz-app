            ...
            <div className="flex flex-col items-start">
              {questions[currentQuestionIndex].options.map((option, index) => {
                ...
                ? isCorrect
                  ...
                  : 'bg-[#F4F6FA]'
                : isSelected
                ? 'bg-[#A729F5] text-white group-hover:bg-[#A729F5] group-hover:text-[#F4F6FA]'
                : ''

                // const correctBg = showAnswer && isCorrect ? 'bg-green-400 group-hover:bg-green-400 text-white group-hover:text-[#F4F6FA]' : '';
                // const incorrectBg = showAnswer && isSelectedAndIncorrect ? 'bg-red-500 text-white group-hover:bg-red-500 group-hover:text-white' : '';
                // const selectedBg = isSelected ? 'bg-purple-500 text-white group-hover:bg-purple-500 group-hover:text-[#F4F6FA]' : '';
                // const defaultBg = 'bg-[#F4F6FA]';
...
//                 const labelBg = showAnswer
//                   ? isCorrect
//                     ? `bg-[#26D782] text-white group-hover:bg-[#26D782] group-hover:text-[#F4F6FA]`
//                     : isSelectedAndIncorrect
//                     ? `bg-[#EE5454] text-white group-hover:bg-[#EE5454] group-hover:text-white`
//                     : ``
//                   : isSelected
//                   ? `bg-[#A729F5] text-white group-hover:bg-[#A729F5] group-hover:text-[#F4F6FA]`
//                   : `bg-[#F4F6FA] group-hover:bg-fuchsia-100 group-hover:text-purple-500`;
...
//                     <div className='flex items-center'>
//                       <div
//                         className={`md:w-12 md:h-12 p-1 grid justify-center items-center text-darkthin dark:text-[#3B4D66] mr-5 text-3xl rounded-lg ${labelBg}`}
//                       >
//                         {label}
//                       </div>
//                       <span>{option}</span>
